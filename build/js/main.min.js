...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var lots = document.querySelectorAll('.lots__item');
  if (lots) {
  ...
  var viewPasswordButtons = document.querySelectorAll('.connection__view-password');
  if (viewPasswordButtons) {
    viewPasswordButtons.forEach(function (viewPassword) {
      viewPassword.addEventListener('click', function () {
        var passwordField = viewPassword.parentElement;
  ...
  if (mapItems) {
    mapItems.forEach(function (item) {
      item.onmouseenter = function () {
        var itemID = this.id;
        document.getElementById("".concat(itemID, "-img")).querySelector('.map__img').classList.add('visually-hidden');
        document.getElementById("".concat(itemID, "-img")).querySelector('.map__img-active').classList.remove('visually-hidden');
        document.getElementById("".concat(itemID)).classList.add('map__item--active');
        document.getElementById("".concat(itemID, "-img")).querySelector('.map__number').classList.add('map__number--img-active');
      };
      item.onmouseleave = function () {
        var itemID = this.id;
        document.getElementById("".concat(itemID, "-img")).querySelector('.map__img').classList.remove('visually-hidden');
        document.getElementById("".concat(itemID, "-img")).querySelector('.map__img-active').classList.add('visually-hidden');
        document.getElementById("".concat(itemID)).classList.remove('map__item--active');
        document.getElementById("".concat(itemID, "-img")).querySelector('.map__number').classList.remove('map__number--img-active');
      };
    });
  }
  var imgMapItems = document.querySelectorAll('.map__number--img');
  if (imgMapItems) {
    imgMapItems.forEach(function (item) {
      item.onmouseenter = function () {
        var itemMapID = this.id;
        document.getElementById("".concat(itemMapID, "-map-img")).querySelector('.map__img').classList.add('visually-hidden');
        document.getElementById("".concat(itemMapID, "-map-img")).querySelector('.map__img-active').classList.remove('visually-hidden');
        document.getElementById("".concat(itemMapID)).classList.add('map__number--img-active');
        document.getElementById("".concat(itemMapID, "-map")).classList.add('map__item--active');
      };
      item.onmouseleave = function () {
        var itemMapID = this.id;
        document.getElementById("".concat(itemMapID, "-map-img")).querySelector('.map__img').classList.remove('visually-hidden');
        document.getElementById("".concat(itemMapID, "-map-img")).querySelector('.map__img-active').classList.add('visually-hidden');
        document.getElementById("".concat(itemMapID)).classList.remove('map__number--img-active');
        document.getElementById("".concat(itemMapID, "-map")).classList.remove('map__item--active');
      };
    });
  }
  var buttonRegistration = document.querySelector('[data-button="registration"]');
  var buttonRecoveryPassword = document.querySelector('[data-button="recovery-password"]');
  var buttonSuccessRecoveryPassword = document.querySelector('[data-button="send"]');
  ...
  var buttonCloseRegistration = document.querySelector('[data-modal="success-registration"]');
  ...
  var buttonClosePasswordRecovery = document.querySelector('[data-modal="password-recovery"]');
  ...
  var buttonCloseSuccessPasswordRecovery = document.querySelector('[data-modal="success-password-recovery"]');
  ...
  var lotItems = document.querySelectorAll('.lots__item');
  if (lotItems) {
    lotItems.forEach(function (i) {
      var addFavLotButton = i.querySelector('.favorite');
      if (addFavLotButton) {
  ...
  var lotTitles = document.querySelectorAll('.lots__lot-name');
  function checkHeight() {
    lotTitles.forEach(function (i) {
      i.style.height = "auto";
    });
    var maxHeight = 0;
    lotTitles.forEach(function (i) {
  ...
  var repeatPhoneMask = document.getElementById('phone-repeat');
  var maskOptions = {
    mask: '+{7} (000) 000-00-00'
  };
  if (phoneMask) {
    var mask = (0, _imask.default)(phoneMask, maskOptions);
  }
  if (repeatPhoneMask) {
    var _mask = (0, _imask.default)(repeatPhoneMask, maskOptions);
  }
  var dateMask = document.getElementById('birth-date');
  if (dateMask) {
    (0, _imask.default)(dateMask, {
      mask: Date,
      // lazy: false,
      ...
      blocks: {
        YYYY: {
          mask: _imask.default.MaskedRange,
          from: 1900,
          to: 2024
        },
        MM: {
  ...
  ;
  var loginForm = document.querySelector('.log-in__navigation-item--login');
  var registrationForm = document.querySelector('.log-in__navigation-item--registration');
  if (loginForm) {
  ...
  var personAccount = document.querySelector('.account__navigation-item--personal');
  var favoriteAccount = document.querySelector('.account__navigation-item--favorite');
  var archiveAccount = document.querySelector('.account__navigation-item--archive');
  if (personAccount) {
  ...
  var photoSwiper = document.querySelector('.mySwiper2');
  if (photoSwiper) {
    var photos = photoSwiper.querySelectorAll('.lots__photo-item');
    var closeZoomModal = document.querySelector('.zoom--closed');
    if (screenWidth < 500) {
...
var editSources = document.querySelectorAll('.lots__photo-item');
if (editSources) {
  editSources.forEach(function (item) {
    var pictureElement = item.querySelector('picture');
    if (pictureElement) {
      var imgElement = pictureElement.querySelector('img');
      if (imgElement) {
        pictureElement.outerHTML = "<!--".concat(pictureElement.outerHTML.replace(imgElement.outerHTML, ''), "-->").concat(imgElement.outerHTML);
      }
    }
  });
}
var swiper2 = document.querySelector('.mySwiper2');
var swiper3 = document.querySelector('.mySwiper3');
var swiperInformation = document.querySelector('.card__information-wrapper');
var swiperParent = document.querySelector('.container--lot-card');
var sliderHeight = 0;
var screenWidth = window.innerWidth;
window.addEventListener('load', function () {
  screenWidth = window.innerWidth;
...
var navigation = document.querySelector('.navigation__list--desktop');
var cityList = document.querySelector('.navigation__select-list');
var filter = document.querySelector('.filter-sorting__select-list');
...
function clickOutside() {
  document.addEventListener('click', function (event) {
    if (navigation && cityList && document.querySelector('.mySwiper2') && document.querySelector('.mySwiper3')) {
      var _isClickInsideNav = navigation.contains(event.target);
      var _isClickInsideCity = cityList.contains(event.target);
      var _isClickInsideZoom = document.querySelector('.mySwiper2').contains(event.target);
      var _isClickInsideZoom2 = document.querySelector('.mySwiper3').contains(event.target);
    }
    if (filter) {
      var _isClickInsideSort = filter.contains(event.target);
    }
...
var cardSigns = document.querySelectorAll('.card__signs-wrapper');
if (cardSigns) {
  cardSigns.forEach(function (i) {
    var button = i.querySelector('.favorite__button');
  ...
  document.querySelector('.filter-sorting__select-list').addEventListener('click', function (evt) {
    ...
    if (evt.target.matches('.filter-sorting__select-item')) {
      ...
      if (document.querySelector('.filter-sorting__select').dataset.filter === "ascending-price") {
        var list = document.querySelector('.lots__list');
        ...
        itemsArr.sort(function (a, b) {
          return parseFloat(a.getAttribute('data-price')) == parseFloat(b.getAttribute('data-price')) ? 0 : parseFloat(a.getAttribute('data-price')) > parseFloat(b.getAttribute('data-price')) ? 1 : -1;
        });
      ...
      if (document.querySelector('.filter-sorting__select').dataset.filter === "descending-price") {
        var _list = document.querySelector('.lots__list');
        var items = _list.childNodes;
        var itemsArr = [];
        for (var i in items) {
          if (items[i].nodeType == 1) {
            itemsArr.push(items[i]);
      ...
      if (document.querySelector('.filter-sorting__select').dataset.filter === "start-date") {
        ...
        var _list2 = document.querySelector('.lots__list');
        var items = _list2.childNodes;
        var itemsArr = [];
        for (var i in items) {
          if (items[i].nodeType == 1) {
            itemsArr.push(items[i]);
      ...
      if (document.querySelector('.filter-sorting__select').dataset.filter === "end-date") {
        ...
        var _list3 = document.querySelector('.lots__list');
        var items = _list3.childNodes;
        var itemsArr = [];
        for (var i in items) {
          if (items[i].nodeType == 1) {
            itemsArr.push(items[i]);
        ...
        itemsArr.sort(_compare);
        for (i = 0; i < itemsArr.length; ++i) {
          _list3.appendChild(itemsArr[i]);
        }
      }
    }
  });
...
var priceInputModal = document.querySelector('.price-input');
var offerPriceModal = document.querySelector('.checkbox__input--offer');
...
var offerModal = document.querySelector('[data-modal="offer"]');
if (offerModal) {
...
if (document.querySelector('.account__form--personal')) {
  var emailEdit = document.querySelector('.account__form--active').querySelector('.connection__field--edit-email');
  var passwordEdit = document.querySelector('.account__form--personal').querySelector('.connection__field--edit-password');
  var passwordRepeatEdit = document.querySelector('.account__form--personal').querySelector('.connection__field--edit-password-repeat');
  var nameEdit = document.querySelector('.account__form--personal').querySelector('.connection__field--edit-name');
  var dateBirthEdit = document.querySelector('.account__form--personal').querySelector('.connection__field--edit-birth-date');
  var phoneEdit = document.querySelector('.account__form--personal').querySelector('.connection__field--edit-phone');
  var checkboxNotificationEditLabel = document.querySelector('.account__form--personal').querySelector('.checkbox--notification');
  var checkboxNotificationEdit = document.querySelector('.account__form--personal').querySelector('.checkbox--notification').querySelector('.checkbox__input');
  if (emailEdit && passwordEdit && passwordRepeatEdit && nameEdit) {
    emailEdit.addEventListener('input', function () {
      if (EMAIL_REGEXP.test(emailEdit.value) && passwordEdit.value !== "" && passwordEdit.value === passwordRepeatEdit.value && nameEdit.value !== "" && dateBirthEdit.value.length >= 10 && phoneEdit.value.length >= 18) {
...
if (document.querySelector('.log-in__form--main')) {
  var emailEnter = document.querySelector('.log-in__form--main').querySelector('.connection__field--email');
  var passwordEnter = document.querySelector('.log-in__form--main').querySelector('.connection__field--password');
...
if (document.querySelector('.log-in__form--registration')) {
  var emailReg = document.querySelector('.log-in__form--registration').querySelector('.connection__field--reg-email');
  var passwordReg = document.querySelector('.log-in__form--registration').querySelector('.connection__field--reg-password');
  var passwordRepeat = document.querySelector('.log-in__form--registration').querySelector('.connection__field--reg-password-repeat');
  var name = document.querySelector('.log-in__form--registration').querySelector('.connection__field--name');
  var dateBirth = document.querySelector('.log-in__form--registration').querySelector('.connection__field--birth-date');
  var phone = document.querySelector('.log-in__form--registration').querySelector('.connection__field--phone');
  var checkboxAgreementLabel = document.querySelector('.checkbox--agreement');
  var checkboxDataLabel = document.querySelector('.checkbox--data');
  var checkboxNotificationLabel = document.querySelector('.checkbox--notification');
  var checkboxAgreement = document.querySelector('.checkbox--agreement').querySelector('.checkbox__input');
  var checkboxData = document.querySelector('.checkbox--data').querySelector('.checkbox__input');
  var checkboxNotification = document.querySelector('.checkbox--notification').querySelector('.checkbox__input');
...
var emailRecovery = document.querySelector('.connection__field--recovery');
if (emailRecovery) {
...
var deleteButtons = document.querySelectorAll('.account__arhive-button--delete');
if (deleteButtons) {
...
if (hasArchiveClass()) {
  var buttons = document.querySelectorAll('.account__arhive-item');
...
function handleButtonClick(event) {
  ...
  var url = new URL('http://localhost:3002/lots-card.html');
  url.searchParams.set('from', 'archive');
  window.location.href = url.toString();
}
window.addEventListener('load', function () {
  var urlParams = new URLSearchParams(window.location.search);
  var fromArchive = urlParams.get('from') === 'archive';
...
function addZoomClass() {
  var slider = document.querySelector('.card__slider');
  var page = document.querySelector('.page-card');
  var zoom = document.querySelector('.zoom--closed');
  if (slider && page && zoom) {
...
function addCloseListener() {
  var closeLink = document.querySelector('.zoom--closed-link');
  if (closeLink) {
...
},{"./modules/accordion/init-accordion":4,"./modules/sliders/init-lots-slider":5,"./modules/sliders/init-news-slider":6,"./utils/ios-vh-fix":8,"imask":1}],3:[function(require,module,exports){
"use strict";

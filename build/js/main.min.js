...
function clickOutside() {
  document.addEventListener('click', function (event) {
    var isClickInsideNav = navigation.contains(event.target);
    var isClickInsideCity = cityList.contains(event.target);
    var isClickInsideZoom1 = document.querySelector('.mySwiper2').contains(event.target);
    var isClickInsideZoom2 = document.querySelector('.mySwiper3').contains(event.target);
    if (filter) {

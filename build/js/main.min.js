...
if (document.querySelector('.account__form--personal')) {
  ...
  if (emailEdit && passwordEdit && passwordRepeatEdit && nameEdit) {
    emailEdit.addEventListener('input', function () {
      if (EMAIL_REGEXP.test(emailEdit.value) && checkboxNotificationEdit.checked && passwordEdit.value !== "" && passwordEdit.value === passwordRepeatEdit.value && nameEdit.value !== "" && dateBirthEdit.value.length >= 10 && phoneEdit.value.length >= 18) {
